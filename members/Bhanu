 ...
 Componets of Infrastructure ?  Traditional vs cloud Infrastructure ?
 ...
 Creation of NFS and CIFS share
 Expansion of storage - Netapp,IBM, Unity
 ...
 Upgrade of storage devices
 IBM storage - SVC concept
 Complete Removal of IBM SAN storage for a host
...
Terraform 
AWS S3 and other concepts basics
